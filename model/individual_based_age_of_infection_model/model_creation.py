...
initial_conditions.append("U = kappa / (1 + (kappa/(400*xi_i_k) - 1) * exp(-rho));")
...
individual_based_age_of_infection_model = f"""
model individual_based_age_of_infection_model
...
# Load the model
r = te.loada(individual_based_age_of_infection_model)
# Export the model to SBML
r.exportToSBML('petab_files/individual_based_age_of_infection_model.xml', current=False)