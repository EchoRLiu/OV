...
def main():    
    ...
    result = minimize(
        ...
        history_options = pypesto.HistoryOptions(trace_record=False, storage_file='optimization_history/individual_based_age_of_infection_model.hdf5'),
        filename='optimization_history/individual_based_age_of_infection_model.hdf5',
    )
