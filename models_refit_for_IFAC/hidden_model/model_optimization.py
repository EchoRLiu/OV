...
def main():    
    ...
    if load:
        result = pypesto.store.read_result('optimization_history/n'+ str(n_runs) +'_v2_large_beta.hdf5')
    else:
        result = minimize(
            problem=problem,
            ...
            history_options = pypesto.HistoryOptions(trace_record=True, storage_file='optimization_history/n'+ str(n_runs) +'_v2_large_beta.hdf5'),
            filename='optimization_history/n'+ str(n_runs) +'_v2_large_beta.hdf5',
        )
