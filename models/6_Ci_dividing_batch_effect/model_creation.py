...
initial_conditions.append("C_u = (1 / (kappa + exp(-rho) * (1/400 - kappa))) * exp(theta * theta_flag);")
...
dividing_infected_cells_BE_model = f"""
model dividing_infected_cells_BE
...
# Load the model
r = te.loada(dividing_infected_cells_BE_model)
...
# write xml file
# with open('petab_files/dividing_infected_cells_BE.xml', 'w') as f:
#     f.write(sbml_str_before)

r.exportToSBML('petab_files/dividing_infected_cells_BE.xml', current=False)