...
with_delay_approx_model = """
model vvDD_effect_with_delay_approx
...
# Load the model
r = te.loada(with_delay_approx_model)
...
r.exportToSBML('petab_files/with_delay_approx.xml', current=False)